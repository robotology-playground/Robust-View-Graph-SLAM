      ...
      '<tr>' +
        '<td class="search_result_desc">' +
          '<span class="search_title">' +
            '<a href="<%= resolveProductHelpDir(searchResult.product)%>/<%= searchResult.path %><%= appendSearchHighlight() %>"><%=searchResult.title %></a>' +
        ...
        '<% if (searchResult.thumbnail) { %>' +
          '<td class="search_result_additional_right thumb">' +
            '<div class="thumbnail_container" style="background-image:url(../<%=searchResult.thumbnail %>)"></div>' +
          '</td>' +
        '<% } %>' +
