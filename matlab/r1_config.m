...
LAST_IMAGE 		= 1500 ; % where to stop reading the acquisition
DOWN_SAMPLE 	= 5 ; % frames resampling frequency (next_frame = current_frame + DOWN_SAMPLE)
